  ...
  >
    ...
    <div class="table">
      <el-button
        ...
        v-permission:system:bannedword:add
      ...
      <el-table
        ...
        :border="true"
        :max-height="825"
        v-permission:system:bannedword:list
      >
        <el-table-column prop="id" label="ID" align="center" />

        <el-table-column
          prop="content"
          :label="t('banKeyword.table.sensitive')"
          align="center"
        />
          ...
          <template #default="scope">
            ...
            >
              <el-button
                ...
                v-permission:system:bannedword:edit
              >
            ...
            >
              <el-button
                ...
                v-permission:system:bannedword:remove
              >
...
export default {
  ...
  setup() {
    ...
    const getData = () => {
      ...
      http.systemManagement.getIllegal(state.param).then((res) => {
    ...
    const deleteHandler = (id) => {
      ElMessageBox.confirm(t("common.wantToDelete"), t("common.warning"), {
        ...
        .then(() => {
          http.systemManagement.deleteIllegal({ id: id }).then((res) => {
            if (res.data.err_code == 0) {
