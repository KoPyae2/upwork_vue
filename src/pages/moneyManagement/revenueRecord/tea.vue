      ...
      <el-row>
        <el-col :span="24">
          ...
          >
            ...
            />
            <el-table-column
              :label="t('money.typeOf')"
              align="center"
              width="150"
            >
              <template #default="scope">
                {{ checkTransType(scope.row.trans_type_id) }}
              </template>
            </el-table-column>
            <el-table-column
              prop="trans_amount"
              :label="t('money.transationAmount')"
              align="center"
              width="200"
            />
            ...
            <el-table-column
              prop="earn_by"
              :label="t('money.teaCoinEarned')"
              align="center"
              width="200"
            />
            <el-table-column
              :label="t('money.feeRate')"
              align="center"
              width="200"
            >
              <template #default="scope">
            ...
            <el-table-column
              ...
              width="200"
            />
            <!-- <el-table-column label="时间" align="center" width="155px"
              ><template #default="scope">
...
export default {
  ...
  setup(props, context) {
    ...
    const checkTransType = (val) => {
      switch (val) {
        case 1:
          return t("common.normal_recharge");
        case 2:
          return t("common.exchange_recharge");
        case 3:
          return t("common.system_gift");
        case 4:
          return t("common.watch_resources");
        case 5:
          return t("common.give_a_gift");
        case 6:
          return t("common.buy_fan_club");
        case 7:
          return t("common.contact_to_buy");
        case 8:
          return t("common.reward_donation");
        case 9:
          return t("common.unlock_chat");
        case 10:
          return t("common.note_income");
        case 11:
        ...
        case 15:
          return t("common.fan_club_earning");
        case 16:
          return t("common.contact_for_sale");
        case 17:
          return t("common.reward_revenue");
        default:
          return "--";
      }
    };
    ...
    const handlerExport = () => {
      ...
      http.moneyManagement.getTeaCoinReport(state.param).then((res) => {
        if (res.data.err_code === 0) {
          const data = res.data.data.tea_coin_usage;
          exportData(data);
        }
      });
    };
      ...
      data.forEach(
        ({
          ...
          exportData.push({
            trans_no,
            user_name,
            trans_type_id: checkTransType(trans_type_id),
            trans_amount,
            earn_by,
            trans_fee: trans_fee + "/" + trans_fee_rate + "%",
            association: "",
            remark: "--",
            trans_status:
              trans_status == 1 ? t("money.success") : t("money.failed"),
            created_at,
          });
        }
      );
    ...
    const excelExport = () => {
      ...
      import("@/utils/Export2Excel").then((excel) => {
        ...
        const tHeader = [
          ...
          t("common.userName"),
          t("money.typeOf"),
          t("money.transationAmount"),
          t("money.teaCoinEarned"),
          t("money.feeRate"),
          t("money.associationID"),
          t("money.remark"),
          t("money.state"),
        ...
        excel.export_json_to_excel({
          header: tHeader,
          data,
          filename: t("money.billRecord") + date,
          autoWidth: true,
          bookType: "xlsx",
        });
