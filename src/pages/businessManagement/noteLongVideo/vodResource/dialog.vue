<template>
  ...
  >
    <el-form label-width="200px" ref="formRef" :model="form">
      <el-form-item
        :label="t('noteLongVideo.resourceTitle')"
        prop="note_title"
        :rules="[
      ...
      <el-form-item
        :label="t('noteLongVideo.resourceContent')"
        prop="note_content"
        :rules="[
          { required: true, message: t('error.required'), trigger: 'blur' },
        ]"
      ...
      <el-form-item
        :label="t('noteLongVideo.resourceCover')"
        prop="note_cover"
        :rules="[
          { required: true, message: t('error.required'), trigger: 'blur' },
        ]"
      ...
      <el-form-item :label="t('noteLongVideo.resourceImage')">
        <div>
          <div style="display: none">
      ...
      <el-form-item
        :label="t('noteLongVideo.resourceVideo')"
        prop="note_media_url"
        :rules="[
          { required: true, message: t('error.required'), trigger: 'blur' },
        ]"
      >
        ...
        >
          <el-button size="small" type="primary"
            >+ {{ t("noteLongVideo.clickToUpload") }}</el-button
          >
        </el-upload>
      </el-form-item>

      <el-form-item :label="t('noteLongVideo.provinceName')">
        <el-select
          :multiple="false"
          :placeholder="t('noteLongVideo.selectProvinceName')"
          style="width: 100%"
          v-model="province"
          default-first-option
      ...
      <el-form-item :label="t('noteLongVideo.cityName')">
        <el-select
          :multiple="false"
          :placeholder="t('noteLongVideo.selectCity')"
          style="width: 100%"
          v-model="city"
          :disabled="disabled"
          @change="changeCity"
      ...
      <el-form-item :label="t('noteLongVideo.manuallyAddReadingVolume')">
        <el-input
      ...
      <el-form-item :label="t('noteLongVideo.manuallyAddLikes')">
        <el-input
...
export default {
  ...
  setup(props, context) {
    ...
    const openDialog = () => {
      ...
      console.log(props.data.position_at);
      ...
      if (props.data.note_vod_image_2) {
        state.fileVerticalList.push({
          url: props.data.note_vod_image_2,
        });
      }
