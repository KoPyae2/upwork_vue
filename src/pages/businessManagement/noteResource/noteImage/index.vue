<template>
  <div
    ...
    v-loading="isLoading"
  >
    <div class="form" v-permission:resource:image:list>
      <div class="form-content">
        <el-form label-position="top" label-width="300px">
          <el-form-item :label="t('noteResource.resourceIDTitle')">
            <el-input
              :placeholder="t('noteResource.enterResourceIDTitle')"
          ...
          <el-form-item :label="t('noteResource.allTopics')">
            ...
            >
              ...
              <el-option
                ...
                :key="item.id"
                :value="item.id"
                :label="findNameFilter(item.name)"
              >
              </el-option>
            </el-select>
          </el-form-item>
    ...
    <div class="table">
      ...
      <el-table
        ...
        :border="true"
        v-permission:resource:image:list
        :max-height="825"
      >
        <el-table-column
          prop="note_id"
          ...
          <template #default="scope">
            ...
            >
              <el-button
                ...
                v-permission:resource:image:edit
              >
          ...
          <template #default="scope">
            ...
            >
              <el-button
                ...
                v-permission:resource:image:remove
              >
  ...
  setup() {
    ...
    const filter = () => {
      ...
      if (state.filterForm.dateValue && state.filterForm.dateValue.length) {
        // state.param.start_date = moment(
        //   `${state.filterForm.dateValue[0]} 00:00:00`
        // )
        //   .utcOffset("+13:30")
        //   .format("YYYY-MM-DD HH:mm:ss");

        // state.param.end_date = moment(
        //   `${state.filterForm.dateValue[1]} 23:59:59`
        // )
        //   .utcOffset("+13:30")
        //   .format("YYYY-MM-DD HH:mm:ss");
    ...
    const checkDate = (date) => {
      return moment(date).utcOffset(-90).format("YYYY-MM-DD HH:mm:ss");
    };
