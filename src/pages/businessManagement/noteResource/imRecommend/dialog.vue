<template>
  ...
  >
    <el-form label-width="200px" ref="formRef" :model="form">
      ...
      <el-form-item :label="t('noteResource.resourceCover')" prop="note_cover">
        <div>
      ...
      <el-form-item
        :label="t('noteResource.resourceVideo')"
        prop="note_media_url"
        :rules="[
          { required: true, message: t('error.required'), trigger: 'blur' },
        ]"
      >
        ...
        >
          <el-button size="small" type="primary"
            >+ {{ t("noteResource.clickToUpload") }}</el-button
          >
        </el-upload>
      </el-form-item>
      ...
      <el-form-item :label="t('noteResource.cityName')">
        <el-select
          :multiple="false"
          :placeholder="t('noteResource.pleaseSelectCity')"
          style="width: 100%"
          v-model="city"
          :disabled="disabled"
          @change="changeCity"
