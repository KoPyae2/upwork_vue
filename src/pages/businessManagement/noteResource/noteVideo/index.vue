<template>
  ...
  >
    <div class="form" v-permission:resource:video:list>
    ...
    <div class="table">
      ...
      <el-table
        ...
        :border="true"
        v-permission:resource:video:list
        :max-height="825"
      >
        <el-table-column
          prop="note_id"
        ...
        >
          <template #default="scope">
            <el-button
              ...
              v-if="scope.row.note_push == 0"
              v-permission:resource:video:edit
            >
          ...
          <template #default="scope">
            ...
            >
              <el-button
                ...
                v-permission:resource:video:remove
              >
