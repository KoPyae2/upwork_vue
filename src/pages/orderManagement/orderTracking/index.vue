<template>
  ...
  >
    <div class="form" v-permission:order:track:list>
    ...
    <div class="table">
      <el-button
        ...
        v-permission:order:track:list
        :disabled="
          tableList.tableData.list.list &&
          !tableList.tableData.list.list.length > 0
        "
      >
        <font-awesome-icon
...
export default {
  ...
  setup() {
    ...
    const tableList = useTableData(http.orderManagement.getOrderTracking);
    ...
    const excelExport = () => {
      ...
      import("@/utils/Export2Excel").then((excel) => {
        ...
        excel.export_json_to_excel({
          header: tHeader,
          data,
          filename: t("menu.order_tracking") + date,
          autoWidth: true,
          bookType: "xlsx",
        });
