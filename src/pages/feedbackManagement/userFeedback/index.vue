<template>
  ...
  >
    <div class="form" v-permission:feedback:user:list>
    ...
    <div class="table">
      <el-button
        ...
        v-permission:feedback:user:list
    ...
    const excelExport = () => {
      ...
      import("@/utils/Export2Excel").then((excel) => {
        ...
        excel.export_json_to_excel({
          header: tHeader,
          data,
          filename: t("menu.user_feedback") + date,
          autoWidth: true,
          bookType: "xlsx",
        });
        state.isLoading = false;
