<template>
  <div
    ...
    v-loading="isLoading"
  >
    <div class="form" v-permission:user:normal:list>
    ...
    <div class="table">
      ...
      >
        ...
        <!-- <el-table-column prop="note_count" label="发布资源" align="center" />
        <el-table-column prop="follow_count" label="关注" align="center" /> -->
...
export default {
  ...
  setup() {
    ...
    const banUser = (row) => {
      ElMessageBox.confirm("禁提后用户将不能提款？", "警告", {
    ...
    const excelExport = () => {
      ...
      import("@/utils/Export2Excel").then((excel) => {
        ...
        excel.export_json_to_excel({
          header: tHeader,
          data,
          filename: t("menu.normal_user") + date,
          autoWidth: true,
          bookType: "xlsx",
        });
        state.isLoading = false;
