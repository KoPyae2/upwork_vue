<template>
  <div
    ...
    v-loading="isLoading"
  >
    <div class="form" v-permission:user:test:list>
    ...
    const excelExport = () => {
      ...
      import("@/utils/Export2Excel").then((excel) => {
        ...
        excel.export_json_to_excel({
          header: tHeader,
          data,
          filename: t("menu.test_user") + date,
          autoWidth: true,
          bookType: "xlsx",
        });
        state.isLoading = false;
